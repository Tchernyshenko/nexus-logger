...
// Utils
#include "../internal/path_utils.hpp"

namespace nexus::logger {

FileLogger::FileLogger(const std::string& server_name, std::string filepath)
...
void FileLogger::Write(std::string formatted_message) {
    if (file_.is_open()) { file_ << formatted_message << '\n'; }
}
